...
//////////////////////////////////////////////////////////////////////////
// ALearningGACharacter

ALearningGACharacter::ALearningGACharacter()
{
...
void ALearningGACharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ALearningGACharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ALearningGACharacter::Look);
	}
	else
	{
...
void ALearningGACharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ALearningGACharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
